...
#detecting objects using blob. (320,320) and (608,608) can be used instead of (416,416)
...
for i in range(len(boxes)):
    if i in indexes:
        ...
        cv2.putText(img,label+" "+str(round(confidences[i],3)),(x,y+30),font,1,(255,0,0),2)
        
cv2.putText(img,'count_human='+str(count_human),(50,50),font,3,(255,0,0),2)
